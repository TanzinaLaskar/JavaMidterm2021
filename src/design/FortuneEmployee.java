...
public class FortuneEmployee {
    ...
    public static void main(String[] args) {
        EmployeeInfo employee1 = new EmployeeInfo(104, "12345 atlantic ave, NY, 0978");
        EmployeeInfo employee2 = new EmployeeInfo("Tanzina", 103, "9429 Lefferts street, CO, 7875", 'F');
        EmployeeInfo employee3 = new EmployeeInfo("Thamina", "PROD", 105, "11734 brown street, Rego Park, 0809", "USA Citizen");
